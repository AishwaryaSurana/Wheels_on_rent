...
--
-- Host: localhost
-- Generation Time: Jan 13, 2016 at 07:01 PM
...
--
-- Database: `wheels_on_rent`
--
CREATE DATABASE IF NOT EXISTS `wheels_on_rent` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `wheels_on_rent`;
...
CREATE TABLE IF NOT EXISTS `india_states_cities` (
  `state_city_id` int(50) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `india_states_cities` (`state_city_id`, `State/Union Territory`, `City`) VALUES
...
(119, 'Dadra and Nagar Haveli', 'Dadra and Nagar Haveli'),
...
INSERT INTO `owner` (`owner_id`, `name`, `surname`, `address`, `contact_no`, `email`, `password`) VALUES
(32, 'tty', 'tty', 'tty', '123', '123', '123'),
(33, 'qwerty', 'asd', 'asd', 'asd', 'asd', 'asd'),
(34, 'pqr', 'pqr', 'tty', '46454546', 'pqr', '124');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `vehicle_id` int(11) NOT NULL COMMENT '(FOREIGN KEY)',
...
CREATE TABLE IF NOT EXISTS `vehicle` (
  ...
  `wheeler` int(11) NOT NULL,
  `type` varchar(50) NOT NULL,
  `seater` int(11) NOT NULL,
  `Rent_per_km` double NOT NULL,
  `rent_daily` double DEFAULT NULL,
  `State` varchar(30) NOT NULL,
  `City` varchar(30) NOT NULL,
  `owner_id` int(11) NOT NULL COMMENT '(Foreign Key)',
  `name` varchar(50) NOT NULL,
...
INSERT INTO `vehicle` (`vehicle_id`, `wheeler`, `type`, `seater`, `Rent_per_km`, `rent_daily`, `State`, `City`, `owner_id`, `name`, `registration_no`, `driver`, `available`) VALUES
(1, 2, 'bike', 2, 10, 500, 'Madhya Pradesh', 'Indore', 32, 'passion pro', 'asdsad565', 'no', 'yes'),
(2, 2, 'Bike', 2, 50, 100, 'Madhya Pradesh', 'Indore', 34, 'pulsar', 'kkjj', 'no', 'no'),
(3, 4, 'SUV', 8, 100, 2000, 'Andhra Pradesh', 'Guntur', 34, 'Duster', 'ghgvh', 'yes', 'yes');
